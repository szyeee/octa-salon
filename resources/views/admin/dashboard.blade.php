...
<section class="mx-auto max-w-7xl px-6 py-10">
    ...
    <div class="mt-12">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <a href="/admin/reservations" class="group rounded-[2rem] bg-white p-6 shadow-xl shadow-pink-100/50 border border-pink-50 hover:border-pink-300 transition-all hover:-translate-y-1">
