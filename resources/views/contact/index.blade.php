            ...
            <div class="mt-8 space-y-7 text-slate-700">
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1 text-sm text-slate-500"> Jl. Latumeten 1, RT.5/RW.5, Jelambar, Kec. Grogol petamburan, Kota Jakarta Barat, Daerah Khusus Ibukota Jakarta 11460</div>
                    </div>
                </div>
